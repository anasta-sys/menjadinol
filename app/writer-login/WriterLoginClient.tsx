...
export default function WriterLoginClient() {
  ...
  try {
    // Sinkronkan session browser ke cookie server
    // sebelum membuka area khusus Writer.
    await syncSessionToServer();

    setMode("ready");

    // WRITER WAJIB MASUK KE AREA WRITER.
