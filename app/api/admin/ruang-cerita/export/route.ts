...
export async function GET(request: NextRequest) {
  try {
    ...
    const {
      ...
      .select("id, reader_id, title, created_at")
      .eq("id", id)
      .maybeSingle();
